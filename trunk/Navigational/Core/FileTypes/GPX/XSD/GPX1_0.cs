...
//// 
//namespace Core.FileTypes.GPX.XSD.Ver10
//{
...
namespace Core.FileTypes.GPX.XSD.Ver10
{
    ...
    {
        private gpxTrkTrksegTrkpt[] trksegpntField;

        [System.Xml.Serialization.XmlElementAttribute("trkpt")]
        public gpxTrkTrksegTrkpt[] trkpnt
        {
            get
            {
                return this.trksegpntField;
            }
            set
            {
                this.trksegpntField = value;
            }
        }
    }
