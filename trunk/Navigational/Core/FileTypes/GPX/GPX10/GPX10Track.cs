...
{
    class GPX10Track : ITrack
    {
        private readonly GPX.XSD.Ver10.gpxTrk _trkType = null;
        private readonly string _uniqueID = string.Empty;

        private List<ITrackSegment> _trackSegments = null;

        private GeoFramework.Distance _trackLength = GeoFramework.Distance.Empty;
        ...
        private List<ITrackSegment> GetTrackSegments()
        {
            ...
            {
                ITrackSegment trackSegment = new GPX10TrackSegment(_trkType.trkseg[0]);
